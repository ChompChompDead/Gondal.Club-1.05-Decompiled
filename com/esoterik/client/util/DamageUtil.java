...
public class DamageUtil implements Util
{
    ...
    public static float calculateDamage(final double posX, final double posY, final double posZ, final Entity entity) {
        ...
        final float damage = (int)((v * v + v) / 2.0 * 7.0 * doubleExplosionSize + 1.0);
        double finald = 1.0;
    ...
    public static float getBlastReduction(final EntityLivingBase entity, final float damageI, final Explosion explosion) {
        if (entity instanceof EntityPlayer) {
            ...
            float damage = CombatRules.func_189427_a(damageI, (float)ep.func_70658_aO(), (float)ep.func_110148_a(SharedMonsterAttributes.field_189429_h).func_111126_e());
            int k = 0;
            try {
