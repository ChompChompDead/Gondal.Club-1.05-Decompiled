        ...
        for (int i = 9; i < 45; ++i) {
            ...
            if (s.func_77973_b() != Items.field_190931_a && s.func_77973_b() instanceof ItemArmor) {
                ...
                if (armor.field_77881_a == type) {
                    final float currentDamage = armor.field_77879_b + EnchantmentHelper.func_77506_a(Enchantments.field_180310_c, s);
        ...
        if (slot == -1 && withXCarry) {
            ...
            for (int i = 1; i < 5; ++i) {
                ...
                if (craftingStack.func_77973_b() != Items.field_190931_a && craftingStack.func_77973_b() instanceof ItemArmor) {
                    ...
                    if (armor.field_77881_a == type) {
                        final float currentDamage = armor.field_77879_b + EnchantmentHelper.func_77506_a(Enchantments.field_180310_c, craftingStack);
