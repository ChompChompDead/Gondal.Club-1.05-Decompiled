...
public class HoleFiller extends Module
{
    ...
    private boolean isInRange(final BlockPos blockPos) {
        ...
        positions.addAll((Collection)this.getSphere(getPlayerPos(), (float)(Object)this.range.getValue(), (int)(Object)this.range.getValue(), false, true, 0).stream().filter((Predicate<? super Object>)this::IsHole).collect((Collector<? super Object, ?, List<? super Object>>)Collectors.toList()));
    ...
    private List<BlockPos> findCrystalBlocks() {
        ...
        if (this.smart.getValue() && this.closestTarget != null) {
            positions.addAll((Collection)this.getSphere(this.getClosestTargetPos(), this.smartRange.getValue(), (int)(Object)this.range.getValue(), false, true, 0).stream().filter((Predicate<? super Object>)this::IsHole).filter((Predicate<? super Object>)this::isInRange).collect((Collector<? super Object, ?, List<? super Object>>)Collectors.toList()));
        }
    ...
    public List<BlockPos> getSphere(final BlockPos loc, final float r, final int h, final boolean hollow, final boolean sphere, final int plus_y) {
        ...
        for (int x = cx - (int)r; x <= cx + r; ++x) {
            for (int z = cz - (int)r; z <= cz + r; ++z) {
                ...
                while (true) {
                    final float f = y;
                    final float f2 = sphere ? (cy + r) : (cy + h);
                    if (f >= f2) {
                        break;
                    }
