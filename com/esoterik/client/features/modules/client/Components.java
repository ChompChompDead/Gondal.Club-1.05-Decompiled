...
public class Components extends Module
{
    ...
    public void drawTargetHud(final float partialTicks) {
        ...
        this.renderer.drawStringWithShadow("Pops: " + esohack.totemPopManager.getTotemPops(target), this.targetHudX.getValue() + 60, this.targetHudY.getValue() + this.renderer.getFontHeight() * 2 + 30, ColorUtil.toRGBA(255, 0, 0, 255));
        GlStateManager.func_179098_w();
        int iteration = 0;
    ...
    public void drawCompass() {
        ...
        if (this.compass.getValue() == Compass.LINE) {
            ...
            RenderUtil.drawLine(this.compassX.getValue() - rotationYaw + 50.0f + zeroZeroYaw, this.compassY.getValue() + 2, this.compassX.getValue() - rotationYaw + 50.0f + zeroZeroYaw, this.compassY.getValue() + this.renderer.getFontHeight() - 2, 2.0f, -61424);
            RenderUtil.drawLine(this.compassX.getValue() - rotationYaw + 50.0f + 45.0f, this.compassY.getValue() + 2, this.compassX.getValue() - rotationYaw + 50.0f + 45.0f, this.compassY.getValue() + this.renderer.getFontHeight() - 2, 2.0f, -1);
            RenderUtil.drawLine(this.compassX.getValue() - rotationYaw + 50.0f - 45.0f, this.compassY.getValue() + 2, this.compassX.getValue() - rotationYaw + 50.0f - 45.0f, this.compassY.getValue() + this.renderer.getFontHeight() - 2, 2.0f, -1);
            RenderUtil.drawLine(this.compassX.getValue() - rotationYaw + 50.0f + 135.0f, this.compassY.getValue() + 2, this.compassX.getValue() - rotationYaw + 50.0f + 135.0f, this.compassY.getValue() + this.renderer.getFontHeight() - 2, 2.0f, -1);
            RenderUtil.drawLine(this.compassX.getValue() - rotationYaw + 50.0f - 135.0f, this.compassY.getValue() + 2, this.compassX.getValue() - rotationYaw + 50.0f - 135.0f, this.compassY.getValue() + this.renderer.getFontHeight() - 2, 2.0f, -1);
    ...
    public void drawOverlay(final float partialTicks) {
        ...
        if (north != null && north != Blocks.field_150350_a) {
            ...
            if (damage != 0) {
                RenderUtil.drawRect(this.holeX.getValue() + 16, this.holeY.getValue(), this.holeX.getValue() + 32, this.holeY.getValue() + 16, 1627324416);
            }
        ...
        if (south != null && south != Blocks.field_150350_a) {
            ...
            if (damage2 != 0) {
                RenderUtil.drawRect(this.holeX.getValue() + 16, this.holeY.getValue() + 32, this.holeX.getValue() + 32, this.holeY.getValue() + 48, 1627324416);
            }
        ...
        if (east != null && east != Blocks.field_150350_a) {
            ...
            if (damage3 != 0) {
                RenderUtil.drawRect(this.holeX.getValue() + 32, this.holeY.getValue() + 16, this.holeX.getValue() + 48, this.holeY.getValue() + 32, 1627324416);
            }
        ...
        if (west != null && west != Blocks.field_150350_a) {
            ...
            if (damage4 != 0) {
                RenderUtil.drawRect(this.holeX.getValue(), this.holeY.getValue() + 16, this.holeX.getValue() + 16, this.holeY.getValue() + 32, 1627324416);
            }
