...
import com.esoterik.client.features.gui.components.items.buttons.*;
...
public class Component extends Feature
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        RenderUtil.drawRect(this.x, this.y + 11.0f, this.x + this.width, this.y + this.height - 6, ((boolean)ClickGui.getInstance().colorSync.getValue()) ? Colors.INSTANCE.getCurrentColor().getRGB() : ClickGui.getInstance().getColor().getRGB());
        if (this.open) {
            RenderUtil.drawRect(this.x, this.y + 12.5f, this.x + this.width, this.y + this.height + totalItemHeight, ColorUtil.toARGB(10, 10, 10, ClickGui.getInstance().backgroundAlpha.getValue()));
        }
