...
public abstract class InjectionPoint
{
    ...
    public static InjectionPoint parse(final IMixinContext context, final MethodNode method, final AnnotationNode parent, final AnnotationNode node) {
        ...
        final int by = Annotations.getValue(node, "by", Integer.valueOf(0));
        final int ordinal = Annotations.getValue(node, "ordinal", Integer.valueOf(-1));
        final int opcode = Annotations.getValue(node, "opcode", Integer.valueOf(0));
