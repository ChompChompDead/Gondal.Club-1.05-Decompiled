...
public class MixinTransformer extends TreeTransformer
{
    ...
    private void printProfilerSummary() {
        ...
        final double timeSliceMixin = actualTime / totalMixinTime * 100.0;
        final double timeSliceLoad = loadTime / totalMixinTime * 100.0;
        final double timeSliceTransform = transformTime / totalMixinTime * 100.0;
        final double timeSliceExport = exportTime / totalMixinTime * 100.0;
    ...
    private void select(final MixinEnvironment environment) {
        ...
        if (elapsedTime > 0.25) {
            ...
            final String perMixinTime = new DecimalFormat("###0.0").format(elapsedMs / totalMixins);
